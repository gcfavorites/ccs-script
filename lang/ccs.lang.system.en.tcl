...
if {[pkg_info lang [list $_name $_lang] on]} {
	...
	set_text -type help -- $_lang die {Shutdown the bot. Specified \002текст\002 will be used as quit-message.}
	...
	set_text $_lang $_name #106 "Server \002%s\002 is already exist in the servers list"
