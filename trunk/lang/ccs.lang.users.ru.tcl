...
if {$ccs(lang,name,$modname,$modlang)} {
	...
	set ccs(help,ru,userlist) {Показывает список пользователей, из юзерлиста, по Вашим параметрам}
	set ccs(help2,ru,userlist) {
	...
	set ccs(args,ru,match) {[-h hostmask]}
	set ccs(help,ru,match) {Показывает список пользователей, из канального листа, отфильтрованных по указанной хостмаски.}
	set ccs(help2,ru,match) {
	...
	set ccs(text,users,ru,#122) "По указанной маске \002%s\002 не найдено ни одного пользователя"
