...
####################################################################################################
	...
	#configure -use_blocktime_limit	1
	...
	#configure -time_format			{%d-%m-%Y %H:%M:%S}
	...
	#set_text ru mslaps #reason	"Массовые слапы запрещены правилами канала"

	################################################################################################
	# Параметры скрипта AMODE                                                                      #
	################################################################################################
	...
	#configure -autoop				0
	#configure -autohalfop			0
	#configure -autovoice			0
	...
	#configure -autodeop			0
	#configure -autodehalfop		0
	#configure -autodevoice		0
	
	################################################################################################
	# Список флагов по которым следует выдавать/забирать оп/хоп/войс при наличии и снятии
	# авторизации
	#configure -flags_autoop		{o|o}
	#configure -flags_autohalfop	{l|l}
	#configure -flags_autovoice	{v|v}
	
	################################################################################################
	# Список флагов исклчения выдачи модов по авто листу
	#configure -flags_amode_exempt	{}
	...
	#configure -file_amode			"$options(dir_data)/ccs.amode.dat"
