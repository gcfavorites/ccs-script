...
if {$ccs(lang,name,$modname,$modlang)} {
	...
	set ccs(args,pod,delhost) {<юзир|хэндл> <хост>|<-m хостмаска>}
	...
	set ccs(args,pod,userlist) {[-f гфлаги|лфлаги] [-h хост]}
	...
	set ccs(text,users,pod,#110) "Хост \002%s\002 пришыд к юзиру \002%s\002 капронавыми нидками."
