...
if {$ccs(lang,name,$modname,$modlang)} {
	...
	set ccs(args,ru,delhost) {<nick/handle> <host>}
	set ccs(help,ru,delhost) {Удаляет выбранный \002host\002 пользователя. Возможно использование масок. * - удаляет все хосты}
	...
	set ccs(args,ru,userlist) {[-f -|flags/flags] [-h hostmask]}
	...
	set ccs(text,users,ru,#110) "Хост \037%s\037 добавлен к пользователю \002%s\002."
