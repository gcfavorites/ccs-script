...
pkg_add lib {ip} "Buster <buster@buster-net.ru> (c)" "2.0.3" "13-Apr-2009" \
	"Библиотека с функциями обработки IP адресов"

if {[package versions [namespace current]::ip] == ""} {
	package ifneeded [namespace current]::ip 2.0.3 "namespace eval [namespace current] {source [info script]}"
	return
}
...
namespace eval ip {
	...
	set IPv4_address_space {
		...
		{224.0.0.0/4}		{Multicast}				{}
		{240.0.0.0/4}		{Future use}			{}
		{2.0.0.0/8} {RIPE NCC} {whois.ripe.net}
		{24.132.0.0/14} {RIPE NCC} {whois.ripe.net}
		{41.0.0.0/8} {AfriNIC} {whois.afrinic.net}
		{43.0.0.0/8} {} {whois.v6nic.net}
		{46.0.0.0/8} {RIPE NCC} {whois.ripe.net}
		{51.0.0.0/8} {RIPE NCC} {whois.ripe.net}
		...
		{141.86.0.0/16} {ARIN} {whois.arin.net}
		{141.64.0.0/11} {RIPE NCC} {whois.ripe.net}
		{141.96.0.0/14} {RIPE NCC} {whois.ripe.net}
		{141.100.0.0/16} {RIPE NCC} {whois.ripe.net}
		...
		{150.0.0.0/8} {APNIC} {whois.apnic.net}
		...
		{154.0.0.0/8} {AfriNIC} {whois.afrinic.net}
