...
namespace eval dns {
	...
	variable description	"Библиотека с функциями обработки DNS запросов"
	# Часть функций взята из tcllib-1.11.1 dns.tcl by Pat Thoyts <patthoyts@users.sourceforge.net>
